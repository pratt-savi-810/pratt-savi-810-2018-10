...
# intersect the treepoints with the buffer segments of the corridor

# intersect_inputs = (r'E:\SAVI810\Final_Project\Data_Test\shape\treepoints.shp', segment_list)
# def intersect_trees_and_segments(trees, list_of_corridor_segments):
#     for i in arcpy.Intersect_analysis(
#         r'E:\SAVI810\Final_Project\Data_Test\shape\treepoints.shp',
#         segment_list,
#
#     )
