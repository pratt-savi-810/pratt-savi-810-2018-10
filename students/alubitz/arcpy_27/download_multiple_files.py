...
url_list = ["https://data.cityofnewyork.us/api/geospatial/a9we-mtpn?method=export&format=Original",
...
filename_list = [
    ...
    "C:/Users/alubitz/Documents/data/wifi_{0}_for_excel.csv".format(todays_date)
]
